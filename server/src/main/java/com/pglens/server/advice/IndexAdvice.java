 ...
 * was also validated against every one of this index's queries — then this one is not needed. Every
 * number is a labeled planner estimate except the write-load counts, which are real.
 */
